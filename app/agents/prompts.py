...
def senior_interviewer_user(round_no: int, blueprint: object, resume_package: object, decision: object) -> str:
    return (
        f"当前轮次:{round_no}\n项目:{blueprint}\n简历包装:{resume_package}\n人工攻防决策:{decision}\n"
        "只输出JSON字段: round, severity, architecture_vulnerabilities, landing_vulnerabilities, logic_vulnerabilities, questions。"
    )
